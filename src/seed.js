export default async function seed(db) {
  ...
  const newTasks = [{id: 1, name: "Taste Javascript", complete: true,  editing: false, new: false},
                    {id: 2, name: "Buy a unicorn",    complete: false, editing: false, new: false},
                    {id: 3, name: "",                 complete: false, editing: false, new: true}];
